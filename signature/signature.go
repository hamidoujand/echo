...
func SignatureString(v, r, s *big.Int) string {
	return hexutil.Encode(ToSignatureBytesWithEthID(v, r, s))
}
...
// ToSignatureBytesWithEthID converts the r, s, v values into a slice of bytes
// keeping the Eth id.
func ToSignatureBytesWithEthID(v, r, s *big.Int) []byte {
	sig := ToSignatureBytes(v, r, s)
...
// the Eth stamp embedded into the final hash.
func stamp(value any) ([]byte, error) {
	...
	// are always unique to the Eth blockchain.
